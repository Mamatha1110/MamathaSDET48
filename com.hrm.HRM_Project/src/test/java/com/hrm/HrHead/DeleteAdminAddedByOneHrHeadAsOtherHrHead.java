...
public class DeleteAdminAddedByOneHrHeadAsOtherHrHead extends BaseClass {

@Test (groups = "Delete")
public void DeleteAdminAddedByOneHrHeadAsOtherHrHeadTest() throws Throwable
{
	...
	dashboardPage.getAdminDashboardPage();
	adminDashboardPage.deleteAdmin(fName);
	}
}

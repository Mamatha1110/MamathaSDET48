...
public class DeleteCorporateAddedByOneHrHeadAsOtherHrHead {
	public static void main(String[] args) throws Throwable {
		...
		driver.findElement(By.name("corporate_name")).sendKeys("Personal Loans");
		...
		for (WebElement corporate : corporateList) {
			if(corporate.getText().equalsIgnoreCase("Personal Loans"))
			{
		...
		//Logout as HR Head
				...
				for (WebElement corporate : corporateList1) {
					if(corporate.getText().equalsIgnoreCase("Perosonal Loans"))
					{
						//Click on delete
						corporate.findElement(By.xpath("//td/button[.='Delete']")).click();
					...
					//Verify if the deleted corporate is displayed or not
					driver.findElement(By.xpath("//th[.='Date Created']")).click();
					driver.findElement(By.xpath("//th[.='Date Created']")).click();
					
					corporateList = driver.findElements(By.xpath("//tr/td[2]"));
					for (WebElement corporate1 : corporateList) {
						if(corporate1.getText().equalsIgnoreCase("Personal Loans"))
						{
							System.out.println("The Corporate is not deleted");
							break;
						}
						else
						{
							System.out.println("The Corporate is deleted");
						}
					}
